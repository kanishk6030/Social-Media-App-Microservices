...
// Setting up the proxy for the media Service
app.use("/v1/media",validateToken,proxy(process.env.MEDIA_SERVICE_URL,{
    ...
    parseReqBody: false // Important for file uploads-it ensures that the request body is not parsed and is proxied as is
}));
...
app.listen(PORT,()=>{
    ...
    logger.info(`Media Service is Running on the PORT ${process.env.MEDIA_SERVICE_URL}`);
